...
<li><a href="createtrios.php">Add Trios</a></li>
</ul>

<?php

$sql = "SELECT Match_ID, Main_Player, Ranking, Player_Two, Player_Three, Main_Player_Primary_Gun, Main_Player_Secondary_Gun, Map_Name, Location_Name FROM Trios";
