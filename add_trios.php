...
$SQL = "INSERT INTO Trios ( Ranking, Main_Player, Player_Two,Player_Three, Main_Player_Primary_Gun, Main_Player_Secondary_Gun, Map_Name, Location_Name) VALUES(";
$SQL.="'".$Ranking."', '".$Main_Player."', '".$Player_Two."','".$Player_Three."', '".$Main_Player_Primary_Gun."', '".$Main_Player_Secondary_Gun."', '".$Map_Name."',  '".$Location_Name."')";
$result = mysqli_query($connection,$SQL);
 ...
 $message = "Ad is successfully added to the database!"; // link to where I got the alert message https://stackoverflow.com/questions/13851528/how-to-pop-an-alert-message-box-using-php
    ...
    window.location.href='trios.php';</script>";
?>
